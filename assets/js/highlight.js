...
className:"template-variable",begin:/\{\{/,end:/\}\}/,contains:[t]}]}}})());hljs.registerLanguage("apache",(()=>{"use strict";return e=>{const n={
...
end:/$/}]})})());hljs.registerLanguage("sql_more",(()=>{"use strict";return e=>{
...
},e.C_BLOCK_COMMENT_MODE,t,e.HASH_COMMENT_MODE]}}})());hljs.registerLanguage("cpp",(()=>{"use strict";function e(e){
...
name:"Elixir",keywords:i,contains:t}}})());hljs.registerLanguage("arduino",(()=>{"use strict";function e(e){
return((...e)=>e.map((e=>(e=>e?"string"==typeof e?e:e.source:null)(e))).join(""))("(",e,")?")
...
r.name="Arduino",r.aliases=["ino"],r.supersetOf="cpp",r}})());hljs.registerLanguage("python",(()=>{"use strict";return e=>{const n={
...
illegal:"[^\\s\\}]"}}})());hljs.registerLanguage("yaml",(()=>{"use strict";return e=>{
